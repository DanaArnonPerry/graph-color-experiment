...
def screen_welcome():
    ...
    st.markdown(
        """
**ברוכה הבאה!**  
במהלך הניסוי יוצגו לך **40 גרפים** של עמודות. בראש כל מסך תופיע שאלה (למשל: *באיזה עמודה הערך הנמוך ביותר?*).  
עליך לבחור במהירות את האות **A–E** המתאימה לתשובה.

**איך עונים?**
- לוחצים על אחד הלחצנים A / B / C / D / E.
